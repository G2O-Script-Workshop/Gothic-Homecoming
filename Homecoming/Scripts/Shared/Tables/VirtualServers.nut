VirtualServersTable <- [
	...
	// ---------------------- DEATH MATCH
	{
		...
		zen = "NEWWORLD\\NEWWORLD.ZEN",
		vworld = virtualServers.khorinisDMClassic
	},
	{
		_type = "DM",
	...
	},
	{
		...
		zen = "ADDON\\ADDONWORLD.ZEN",
		vworld = virtualServers.jarkendarDMClassic
	},
	{
		_type = "DM",
		name = "Colony (Classic DeathMatch)",
		zen = "COLONY.ZEN",
		vworld = virtualServers.colonyDMClassic
	},
	{
		_type = "DM",
		name = "Irdorath (Classic DeathMatch)",
		zen = "NEWWORLD\\DRAGONISLAND.ZEN",
		vworld = virtualServers.irdorathDMClassic
	},
]